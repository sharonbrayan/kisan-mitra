...
<body>
    ...
    <main>
        <br>
        <div class="text-center"><h2>Fruit Seeds</h2></div>
        <br>
        <h4>Introduction to Fruit Seeds</h4>
        <p>Fruit seeds are the starting point for growing your favorite fruits. With the right seeds and a little care, you can enjoy a bountiful harvest of delicious, homegrown fruit.
        </p>
        <br><br>
        <h4>Types of Fruit Seeds</h4>
        <h6>- Heirloom Seeds:</h6>
         <p>Heirloom fruit seeds come from open-pollinated plants that have been saved and handed down through generations. They often produce unique and flavorful fruits.</p>
         <h6>- Hybrid Seeds:</h6>
         <p>Hybrid fruit seeds are bred for specific traits like disease resistance, high yields, or longer shelf life. They can produce more consistent results, but may not retain their characteristics in future generations.</p>
         <h6>- Organic Seeds:</h6>
         <p>Organic fruit seeds are grown without synthetic pesticides, herbicides, or fertilizers. They promote sustainable agriculture and healthier ecosystems.
        </p>
        <br><br>
        <h4>How to Choose the Right Fruit Seeds</h4>
        <h6>- Climate:</h6>
        <p>Select fruit seeds suitable for your local climate and growing conditions.</p>
        <h6>- Soil:</h6>
        <p>Choose fruit seeds that thrive in your soil type.</p>
        <h6>- Space:</h6>
        <p>Consider the mature size of the fruit plant and choose varieties that fit your available space.</p>
        <br><br>
        <h4>Seed Germination and Planting</h4>
        <h6>- Seed Preparation</h6>
        <p>Follow the specific seed preparation instructions for each fruit variety, such as soaking and scarification.</p>
        <h6>- Sowing Seeds</h6>
        ...
        <br><br>
        <h4>Common Fruit Seed-Related Terms</h4>
        ...
        <h6>- Pollination:</h6>
        <p>The transfer of pollen from the male reproductive organ to the female reproductive organ of a plant, necessary for fruit production.</p>
        <br><br>
        <h4>Frequently Asked Questions</h4>
        <p>- How long do fruit seeds take to germinate?</p>
        <p>Germination times vary depending on the fruit variety, but most fruit seeds germinate within 1-6 weeks.</p>
        <p>- Can I save seeds from my own fruit?</p>
        <p>Yes, you can save seeds from your own fruit, but be aware that saved seeds may not retain the same characteristics as the parent plant.</p>
        <p>- How do I store fruit seeds for next season?</p>
        <p>Store fruit seeds in a cool, dry place (around 40°F/4°C and 50% humidity) in airtight containers or envelopes.</p>
    </main>
    <footer>
        <div class="container-fluid  foot-content">
            <div class="row h-100">
                ...
                <div class="col-3 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="me-4">
                        <ul>
                            <p class="i1" style="color: white; margin-bottom: 0px; font-size: 17px;">Fruit Seeds</p>
